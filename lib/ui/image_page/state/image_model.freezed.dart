...
abstract class $ImageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String title, String text, String image});
}
...
class _$_ImageModel with DiagnosticableTreeMixin implements _ImageModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ImageModel(id: $id, title: $title, text: $text, image: $image)';
  }
...
abstract class _ImageModel implements ImageModel {
  const factory _ImageModel(
      ...
      required final String image}) = _$_ImageModel;
